    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="<%= productDetails.getImage1()%>" width="100%" id="MainImage" alt="">

                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="<%= productDetails.getImage1()%>" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="<%= productDetails.getImage2()%>" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="<%= productDetails.getImage3()%>" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="<%= productDetails.getImage4()%>" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="single-pro-details">
                <!--<h6>Home / T-Shirt</h6>-->
                <h4><%= productDetails.getName()%></h4>
                <h2>$<%= productDetails.getPrice()%></h2>
                ...
                <span><%= productDetails.getDescription()%>
                </span>
            </div>
        </section>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <%
                    List<ProductDTO> categoryList = (List<ProductDTO>) request.getAttribute("SIMILAR_PRODUCT");
                    for (ProductDTO similarProduct : categoryList) {
                %>
                <div class="pro">
                    <form action="MainController">
                        <a href="MainController?action=ProductPage&productId=<%= similarProduct.getProductID()%>">
                            <img src="<%= similarProduct.getImage1()%>" alt="">
                            <div class="des">
                                <span><%= similarProduct.getBrand()%></span>
                                <h5><%= similarProduct.getName()%></h5>
                                <div class="star">
                                ...
                                <h4>$<%= similarProduct.getPrice()%></h4>
                            </div>
                        </a>
                        <input type="hidden" name="productID" value="<%= similarProduct.getProductID()%>">
