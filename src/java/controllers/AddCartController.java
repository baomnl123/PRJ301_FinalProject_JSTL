...
public class AddCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO productDetails = productDAO.getSpecificProducts(productID);
            
            String productImage = productDetails.getImage1();
            ...
            ProductDTO product = new ProductDTO(productID, name, price, quantity, productImage);
            boolean check = cart.addProduct(product);
            
            if(check) {
                session.setAttribute("CART", cart);
                request.setAttribute("MESSAGE", "Product added to your cart");
            }
            url = SUCCESS;
