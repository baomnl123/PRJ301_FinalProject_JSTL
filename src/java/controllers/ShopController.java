...
public class ShopController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> listAllProduct = productDAO.listAllProducts();
            
            if(listAllProduct.size() > 0) {
                request.setAttribute("LIST_PRODUCT", listAllProduct);
                url = SUCCESS;
            } else {
                request.setAttribute("MESSAGE", "Your shop are still empty!");
            }
        } catch (Exception e) {
